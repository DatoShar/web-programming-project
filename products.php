...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="Images/icons/amazon-tab-icon.ico">
...
<body class="products-page">
        ...
        <section class="left-section">
            <a href="index.php">
                <div class="title-container">
                    <picture>
                        <source srcset="Images/icons/amazon-logo-white.png" media="(min-width: 700px)">
    ...
    <main>
        <div class="categories">
            <div class="sub"><a href="#Sports">Sports Gear</a></div>
            <div class="sub"><a href="#Home">Home Essentials</a></div>
            <div class="sub"><a href="#Electronics">Electronics</a></div>
            <div class="sub"><a href="#Clothes">Clothes</a></div>
        </div>
